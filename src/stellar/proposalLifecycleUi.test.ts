...
const requestApi = readFileSync(new URL('../../apps/stellar-api/stellar/routes/request.ts', import.meta.url), 'utf8');
const requestService = readFileSync(new URL('../../apps/stellar-api/stellar/server/requestService.ts', import.meta.url), 'utf8');
...
const inboxApi = readFileSync(new URL('../../apps/stellar-api/stellar/routes/inbox.ts', import.meta.url), 'utf8');
const requestInbox = readFileSync(new URL('../../apps/stellar-api/stellar/server/requestInbox.ts', import.meta.url), 'utf8');
...
const demoContract = readFileSync(new URL('../../apps/internal-docs/content/stellar/product/demo-runtime.md', import.meta.url), 'utf8');
...
const productSemantics = readFileSync(new URL('../../apps/internal-docs/content/stellar/architecture/product-semantics.md', import.meta.url), 'utf8');
