...
const developerIndex = doc('../../apps/docs/content/stellar/developers/index.mdx');
const quickstart = doc('../../apps/docs/content/stellar/developers/testnet-quickstart.mdx');
const classic = doc('../../apps/docs/content/stellar/developers/classic.mdx');
const soroban = doc('../../apps/docs/content/stellar/developers/soroban.mdx');
const apiDocs = doc('../../apps/docs/content/stellar/developers/api.mdx');
const agentDocs = doc('../../apps/docs/content/stellar/developers/agent-api.mdx');
const docsArchitecture = doc('../../apps/internal-docs/content/stellar/architecture/documentation-information-architecture.md');
const integrationModel = doc('../../apps/internal-docs/content/stellar/architecture/integration-product-model.md');
const integrationWizard = doc('../IntegrationProfileWizard.tsx');
const intentRoute = doc('../../apps/stellar-api/stellar/routes/intent.ts');
const requestService = doc('../../apps/stellar-api/stellar/server/integrationRequestService.ts');
