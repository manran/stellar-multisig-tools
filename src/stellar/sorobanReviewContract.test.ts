...
const contractPrepareApi = source('../../apps/stellar-api/stellar/routes/contract-prepare.ts');
const intentApi = source('../../apps/stellar-api/stellar/routes/intent.ts');
const importedIntentService = source('../../apps/stellar-api/stellar/server/importedSorobanIntentService.ts');
const intentAuthorizationService = source('../../apps/stellar-api/stellar/server/sorobanIntentAuthorizationService.ts');
const intentExecutionService = source('../../apps/stellar-api/stellar/server/sorobanIntentExecutionService.ts');
const intentReconciliationService = source('../../apps/stellar-api/stellar/server/sorobanIntentExecutionReconciliationService.ts');
const intentEvidence = source('../../apps/stellar-api/stellar/server/sorobanIntentEvidence.ts');
const intentPlanningService = source('../../apps/stellar-api/stellar/server/sorobanIntentPlanningService.ts');
const viteConfig = source('../../apps/web/vite.config.ts');
const envExample = source('../../.env.example');
const requestService = source('../../apps/stellar-api/stellar/server/requestService.ts');
const requestOriginService = source('../../apps/stellar-api/stellar/server/sorobanRequestOrigin.ts');
const requestApi = source('../../apps/stellar-api/stellar/routes/request.ts');
