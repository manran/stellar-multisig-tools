...
const requestApi = readFileSync(new URL('../../../stellar-api/stellar/routes/request.ts', import.meta.url), 'utf8');
const requestService = readFileSync(new URL('../../../stellar-api/stellar/server/requestService.ts', import.meta.url), 'utf8');
...
const inboxApi = readFileSync(new URL('../../../stellar-api/stellar/routes/inbox.ts', import.meta.url), 'utf8');
const requestInbox = readFileSync(new URL('../../../stellar-api/stellar/server/requestInbox.ts', import.meta.url), 'utf8');
const dashboard = readFileSync(new URL('../StellarDashboardApp.tsx', import.meta.url), 'utf8');
const inboxPresentation = readFileSync(new URL('../../../../packages/stellar-core/src/inboxPresentation.ts', import.meta.url), 'utf8');
...
const demoContract = readFileSync(new URL('../../../internal-docs/content/stellar/product/demo-runtime.md', import.meta.url), 'utf8');
...
const productSemantics = readFileSync(new URL('../../../internal-docs/content/stellar/architecture/product-semantics.md', import.meta.url), 'utf8');
...
const uxDesignSystem = readFileSync(new URL('../../../internal-docs/content/stellar/product/ux-design-system.md', import.meta.url), 'utf8');
const readme = readFileSync(new URL('../../../../README.md', import.meta.url), 'utf8');
const webVercelConfig = readFileSync(new URL('../../vercel.json', import.meta.url), 'utf8');
const apiVercelConfig = readFileSync(new URL('../../../stellar-api/vercel.json', import.meta.url), 'utf8');
