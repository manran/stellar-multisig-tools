...
const sorobanAuthCore = source('../../../../packages/stellar-core/src/sorobanAuthorization.ts');
const sorobanCustomAuthCore = source('../../../../packages/stellar-core/src/sorobanCustomAuthorization.ts');
const sorobanContractAdapter = source('../../../../packages/stellar-core/src/sorobanContractAdapter.ts');
const walletKit = source('./walletKit.ts');
const sorobanRpc = source('../../../../packages/stellar-core/src/sorobanRpc.ts');
const contractOperationsClient = source('../contractOperationsClient.ts');
const contractPrepareApi = source('../../../stellar-api/stellar/routes/contract-prepare.ts');
const intentApi = source('../../../stellar-api/stellar/routes/intent.ts');
const importedIntentService = source('../../../stellar-api/stellar/server/importedSorobanIntentService.ts');
const intentAuthorizationService = source('../../../stellar-api/stellar/server/sorobanIntentAuthorizationService.ts');
const intentExecutionService = source('../../../stellar-api/stellar/server/sorobanIntentExecutionService.ts');
const intentReconciliationService = source('../../../stellar-api/stellar/server/sorobanIntentExecutionReconciliationService.ts');
const intentEvidence = source('../../../stellar-api/stellar/server/sorobanIntentEvidence.ts');
const intentPlanningService = source('../../../stellar-api/stellar/server/sorobanIntentPlanningService.ts');
const viteConfig = source('../../vite.config.ts');
const envExample = source('../../../../.env.example');
const requestService = source('../../../stellar-api/stellar/server/requestService.ts');
const requestOriginService = source('../../../stellar-api/stellar/server/sorobanRequestOrigin.ts');
const requestApi = source('../../../stellar-api/stellar/routes/request.ts');
const productSemantics = source('../../../internal-docs/content/stellar/architecture/product-semantics.md');
const sorobanContract = source('../../../internal-docs/content/stellar/development/soroban-authorization.md');
