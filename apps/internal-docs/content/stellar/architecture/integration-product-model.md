...
- when a derived channel is missing, a deployment-owned creator account activates it with a normal Stellar CreateAccount transaction and initial XLM funding before the channel is reloaded for use;
